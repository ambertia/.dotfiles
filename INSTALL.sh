...
sleep 5
pacman -S cutefish-icons grim hypridle hyprlock imagemagick kitty mako plymouth rofi-wayland slurp starship swappy ttf-jetbrains-mono-nerd ttf-iosevka-nerd waybar
